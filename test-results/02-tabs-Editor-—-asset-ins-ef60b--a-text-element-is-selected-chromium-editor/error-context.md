...
- Name: 02-tabs.spec.ts >> Editor — asset & inspector tabs >> inspector shows Element summary when a text element is selected
- Location: tests\02-tabs.spec.ts:188:6

# Error details

```
Error: element 51d9712c-4213-4a17-8887-08192b05fb7b not in state
