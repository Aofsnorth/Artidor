...
- Name: 02-tabs.spec.ts >> Editor — asset & inspector tabs >> Color tab is reachable from the left bar
- Location: tests\02-tabs.spec.ts:165:6
...
Call log:
  - waiting for getByRole('button', { name: /^Color$/i }).first()
