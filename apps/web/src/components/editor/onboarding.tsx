				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title="Welcome to Artidor Beta! 🎉" />
							<Description description="You're among the first to try Artidor - the fully open source CapCut alternative." />
						</div>
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							...
							<Description description="If you're curious, check out our roadmap [here](https://artidor.vercel.app/roadmap)" />
						</div>
						<NextButton onClick={handleNext}>Next</NextButton>
					</div>
				);
