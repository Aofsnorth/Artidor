...
const LIGHTNING_BOLT_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const lightningBoltGraphicDefinition: GraphicDefinition = {
	id: "lightning-bolt",
	name: "Lightning Bolt",
	keywords: ['lightning', 'bolt'],
	params: LIGHTNING_BOLT_PARAMS,
