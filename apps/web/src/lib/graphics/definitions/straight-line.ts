...
const STRAIGHT_LINE_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const straightLineGraphicDefinition: GraphicDefinition = {
	id: "straight-line",
	name: "Straight Line",
	keywords: ['line', 'straight'],
	params: STRAIGHT_LINE_PARAMS,
