...
const DOUBLE_ARROW_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const doubleArrowGraphicDefinition: GraphicDefinition = {
	id: "double-arrow",
	name: "Double Arrow",
	keywords: ['arrow', 'double'],
	params: DOUBLE_ARROW_PARAMS,
