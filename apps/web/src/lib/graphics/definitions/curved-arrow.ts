...
const CURVED_ARROW_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const curvedArrowGraphicDefinition: GraphicDefinition = {
	id: "curved-arrow",
	name: "Curved Arrow",
	keywords: ['arrow', 'curved'],
	params: CURVED_ARROW_PARAMS,
