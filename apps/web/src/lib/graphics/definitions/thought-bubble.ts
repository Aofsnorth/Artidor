...
const THOUGHT_BUBBLE_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const thoughtBubbleGraphicDefinition: GraphicDefinition = {
	id: "thought-bubble",
	name: "Thought Bubble",
	keywords: ['bubble', 'thought'],
	params: THOUGHT_BUBBLE_PARAMS,
