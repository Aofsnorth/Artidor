...
const DOUBLE_CHEVRON_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const doubleChevronGraphicDefinition: GraphicDefinition = {
	id: "double-chevron",
	name: "Double Chevron",
	keywords: ['chevron', 'double'],
	params: DOUBLE_CHEVRON_PARAMS,
