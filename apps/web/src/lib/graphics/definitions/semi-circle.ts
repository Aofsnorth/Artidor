...
const SEMI_CIRCLE_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const semiCircleGraphicDefinition: GraphicDefinition = {
	id: "semi-circle",
	name: "Semi Circle",
	keywords: ['semi', 'circle'],
	params: SEMI_CIRCLE_PARAMS,
