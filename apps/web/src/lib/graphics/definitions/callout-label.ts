...
const CALLOUT_LABEL_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const calloutLabelGraphicDefinition: GraphicDefinition = {
	id: "callout-label",
	name: "Callout Label",
	keywords: ['callout', 'label'],
	params: CALLOUT_LABEL_PARAMS,
