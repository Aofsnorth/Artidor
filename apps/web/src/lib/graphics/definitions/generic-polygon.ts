...
const GENERIC_POLYGON_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const genericPolygonGraphicDefinition: GraphicDefinition = {
	id: "generic-polygon",
	name: "Generic Polygon",
	keywords: ['polygon'],
	params: GENERIC_POLYGON_PARAMS,
