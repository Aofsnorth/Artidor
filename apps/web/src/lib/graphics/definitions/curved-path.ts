...
const CURVED_PATH_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const curvedPathGraphicDefinition: GraphicDefinition = {
	id: "curved-path",
	name: "Curved Path",
	keywords: ['path', 'curved'],
	params: CURVED_PATH_PARAMS,
