...
const QUARTER_CIRCLE_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const quarterCircleGraphicDefinition: GraphicDefinition = {
	id: "quarter-circle",
	name: "Quarter Circle",
	keywords: ['quarter', 'circle'],
	params: QUARTER_CIRCLE_PARAMS,
