...
const DASHED_LINE_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const dashedLineGraphicDefinition: GraphicDefinition = {
	id: "dashed-line",
	name: "Dashed Line",
	keywords: ['line', 'dashed'],
	params: DASHED_LINE_PARAMS,
