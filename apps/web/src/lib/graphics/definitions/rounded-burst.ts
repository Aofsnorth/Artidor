...
const ROUNDED_BURST_PARAMS: ParamDefinition[] = [FILL_PARAM, ...STROKE_PARAMS];

export const roundedBurstGraphicDefinition: GraphicDefinition = {
	id: "rounded-burst",
	name: "Rounded Burst",
	keywords: ['burst', 'rounded'],
	params: ROUNDED_BURST_PARAMS,
