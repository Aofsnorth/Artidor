...
export const metadata: Metadata = {
	title: "Roadmap - Artidor",
	description:
		"See what's coming next for Artidor - the free, open-source video editor that respects your privacy.",
	openGraph: {
		title: "Artidor Roadmap - What's Coming Next",
		description:
			"See what's coming next for Artidor - the free, open-source video editor that respects your privacy.",
		type: "website",
		images: [
...
export default function RoadmapPage() {
	return (
		<BasePage
			title="Roadmap"
			description={`What's coming next for Artidor (last updated: ${LAST_UPDATED})`}
		>
			<div className="mx-auto flex max-w-4xl flex-col gap-16">
				...
				<GitHubContributeSection
					title="Want to help?"
					description="Artidor is open source and built by the community. Every contribution,
