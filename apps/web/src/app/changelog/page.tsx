...
export const metadata: Metadata = {
	title: "Changelog - Artidor",
	description: "What's new in Artidor",
	openGraph: {
		title: "Changelog - Artidor",
		description: "Every update, improvement, and fix to Artidor — documented.",
		type: "website",
		images: [
			{
...
export default function ChangelogPage() {
	...
	return (
		<BasePage title="Changelog" description="See what's new in Artidor">
